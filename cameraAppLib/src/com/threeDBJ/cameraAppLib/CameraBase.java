...
public abstract class CameraBase extends SurfaceView implements SurfaceHolder.Callback, Runnable {
    private static final String TAG = "Camera::SurfaceView";
